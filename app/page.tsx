...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = settings.seoHomepageTitle || `${siteName} — Typing, NIN, AI Tutor & Document Services Nigeria`;
  const description = settings.seoHomepageDesc || "Nigeria's #1 AI-powered digital computer centre. Professional document typing, NIN registration, academic help, CV writing, AI tutoring, transcription and more — delivered fast online.";
  const keywords = settings.seoHomepageKeywords ? settings.seoHomepageKeywords.split(",").map(k => k.trim()) : [
