...
export default function BecomeVendorModal({ isOpen, onClose }: BecomeVendorModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="glass-card flex-col gap-6 relative z-10 animate-in fade-in zoom-in duration-300" style={{ maxWidth: "500px", padding: "var(--space-10)", border: "1px solid var(--brand-primary)" }}>
         <button 
           onClick={onClose}
           className="absolute top-4 right-4 p-2 rounded-full hover:bg-subtle text-muted transition-colors"
         >
           <X size={20} />
         </button>

         <div className="flex-col items-center text-center gap-4">
            <div style={{ width: 64, height: 64, borderRadius: "20px", background: "var(--grad-primary)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", boxShadow: "0 8px 32px rgba(108, 71, 255, 0.4)" }}>
               <Store size={32} />
            </div>
            <div className="flex-col gap-1">
               <h2 style={{ margin: 0, fontSize: "1.75rem" }}>Become a <span className="text-gradient">Vendor</span></h2>
         ...
         <div className="flex-col gap-4 py-4">
            ...
            <FeatureItem 
              ...
              title="Secure Escrow" 
              desc="Never worry about payments. All funds are held in escrow until completion." 
            />
            <FeatureItem 
